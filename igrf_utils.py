    ...
    with open(filepath, 'r') as f:
        ...
        for line in f.readlines():
            ...
            if read_line.size == 7:
                ...
                values = [name] + read_line.astype(np.int64).tolist()
...
def synth_values(coeffs, radius, theta, phi, \
    ...
    radius = np.array(radius, dtype=np.float64) / 6371.2  # Earth's average radius
...
def xyz2dhif(x, y, z):
    ...
    #print("\nfunc_xyz2dhif : tipo da variavel dec : ",type(dec),"\n\neff: ",eff)
